...
export default function Component() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-900 bg-opacity-90 relative">
      <div
        className="absolute inset-0 bg-cover bg-center z-0 opacity-20"
        style={{ backgroundImage: "url('/MatiMati_crop.jpg')" }}
      ></div>
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="sticky bottom-0 bg-zinc-800 bg-opacity-90 p-4 space-y-4">
          {isLoadingImages ? (
        ...
        <div className="bg-zinc-900 bg-opacity-90 py-4">
